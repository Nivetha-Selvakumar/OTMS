...
class SubTaskMapperTest {
    ...
    void taskModelToEntityTest(){
        TaskEntity taskEntity1 = subTaskMapper.subTaskModelToEntity(taskDTO,taskEntity);
    ...
    void taskEntityToModel(){
        TaskDTO taskDTO1 = subTaskMapper.subTaskEntityToModel(taskEntity);
    ...
    void taskUpdateModeltoEntityTest(){
        TaskEntity taskEntity1 = subTaskMapper.subTaskUpdateModelToEntity(taskUpdateDTO,taskEntity);
